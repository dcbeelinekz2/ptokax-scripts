--[[ 
	...
	- Changed: User nick doesn't count for Control messages - requested by GeceBekcisi (2/28/2006)
	...
	- Fixed: nil/1 in adCheck function - reported by Yevgeniy and TïMê†råVêlléR (3/8/2006)
	...
	if tSettings.SendMsg then
		for i,v in ipairs(frmHub:GetOnlineUsers()) do 
			if tSettings.tFeedProfiles[v.iProfile] then 
				local tTable = {
					["main"] = function(a,b) v:SendData(a,b) end,
					["pm"] = function(a,b) v:SendPM(a,b) end,
				}
