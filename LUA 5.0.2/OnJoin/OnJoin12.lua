...
function Message(user)
	...
	user:SendData("     -×--- Usuários Online: "..getOn(3).." - OP's: "..getOn(1).." - ViP's: "..getOn(2).." - NetOP's: "..getOn(5).." - Máximo: "..frmHub:GetMaxUsers().." ---×-") 
	...
	user:SendData("     -×--- Peak --×-- Conexões: "..Stat.logins.." - Compartilhamento: "..rightSize( tonumber(ttshare) ).." - Usuários: "..Stat.users.." ---×-") 
