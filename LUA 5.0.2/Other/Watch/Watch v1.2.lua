...
--								table.insert(watch[victim.sName],victim.sName)
								watch[victim.sName] = {["Pass"] = "", ["Profile"] = ""}
--								watch[victim.sName][1] = user.sName
--								table.insert(watch[victim.sName],user.sName)
			...
			["watchoff"] =	function (user,data)
						if isEmpty(watch) then
							...
							watch[victim.sName].Pass = nil
--							table.remove(watch[victim.sName],2)
--							watch[victim.sName][1] = nil
--							watch[victim.sName].Pass = nil
