--[[
	...
	RSS Bot v1.1 - LUA 5.1 by jiten (8/20/2006)
	...
	- In order to use the RSS Mode, you must download the PxWSA lib (PxWSA 0.1.1.1-Dbg) and unzip it to 
	  your scripts\libs\ folder. You'll also need to place the Borland dependencies under your scripts' folder.
	
	Download Link: http://libs.ptokax.ath.cx/#pxwsa
	...
	- Added: Comments to the code (3/25/2006);
	- Changed: Added compatibility with LUA 5.1 (8/20/2006)
...
-- Init WSA lib
libinit = package.loadlib(Settings.sLibFolder.."/pxwsa_l51.dll", "_libinit")
libinit()
...
tFunctions.RSSParser = function(rFeed)
	...
	if sUser and Host and trig and rFeed then
		...
		for a,b in pairs(tTable[2]) do
			...
			for sItem in string.gmatch(rFeed,a.."(.-)"..b) do
