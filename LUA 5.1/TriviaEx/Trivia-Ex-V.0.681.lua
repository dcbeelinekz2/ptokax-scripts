--[[
	...
	Trivia Ex V 0.681 by chill - LUA 5.0/5.1
	¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
	...
	Added: !trivreport and !showreport to help the debugging process (requested by phorum) (7/4/2005)
	...
	Changed: Added compatibility with LUA 5.1 (7/29/2006)
		 'require' to 'dofile' and 'foreach(i)' loops to '(i)pairs'
